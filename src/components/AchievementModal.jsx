...
const AchievementModal = ({ id, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-100">
      <div className="bg-white w-[400px] max-h-[85vh] overflow-y-auto p-6 rounded-lg relative">
        <button onClick={onClose} className="absolute top-0 right-2 text-lg font-bold">  ✕ </button>
         {data && (
